        ...
        switch (choice) {
            ...
            case 10: {
                ...
                std::cout << "✓ Converted to grayscale in " << std::fixed << std::setprecision(4) 
                          << duration_ms << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 14: {
                ...
                std::cout << "✓ Otsu threshold applied in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 15: {
                ...
                std::cout << "✓ Adaptive threshold applied in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 16: {
                ...
                std::cout << "✓ Image inverted in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 17: {
                ...
                std::cout << "✓ Gamma correction applied in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 20: {
                ...
                std::cout << "✓ Salt & pepper noise added in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 21: {
                ...
                std::cout << "✓ Gaussian noise added in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 22: {
                ...
                std::cout << "✓ Speckle noise added in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 30: {
                ...
                std::cout << "✓ Box blur applied in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 31: {
                ...
                std::cout << "✓ Gaussian blur applied in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 32: {
                ...
                std::cout << "✓ Median filter applied in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 33: {
                ...
                std::cout << "✓ Bilateral filter applied in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 40: {
                ...
                std::cout << "✓ Sobel edge detection applied in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 41: {
                ...
                std::cout << "✓ Canny edge detection applied in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 42: {
                ...
                std::cout << "✓ Sharpen filter applied in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 43: {
                ...
                std::cout << "✓ Prewitt edge detection applied in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 44: {
                ...
                std::cout << "✓ Laplacian edge detection applied in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 53: {
                ...
                std::cout << "✓ " << opDesc << " applied in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 54: {
                ...
                std::cout << "✓ Morphological gradient applied in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 60: {
                ...
                std::cout << "✓ Image rotated in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 61: {
                ...
                std::cout << "✓ Image resized in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 62: {
                ...
                std::cout << "✓ Image translated in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 63: {
                ...
                std::cout << "✓ Image flipped horizontally in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 64: {
                ...
                std::cout << "✓ Image flipped vertically in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 70: {
                ...
                std::cout << "✓ Channels split in " << std::fixed << std::setprecision(4) 
                          << duration_ms << " ms (" << duration_us.count() << " μs) (Serial). Saving...\n";
            ...
            case 71: {
                ...
                std::cout << "✓ Converted to HSV in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 72: {
                ...
                std::cout << "✓ Hue adjusted in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 73: {
                ...
                std::cout << "✓ Saturation adjusted in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 74: {
                ...
                std::cout << "✓ Value adjusted in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
            ...
            case 75: {
                ...
                std::cout << "✓ Color balance adjusted in " << std::fixed << std::setprecision(4) << duration_ms 
                          << " ms (" << duration_us.count() << " μs) (Serial)\n";
                break;
            }
